    ...
    return (
        <main>
            ...
            <p className="mt-5 text-gray-500">
                ...
                <code>gsap.from()</code> method, but the different is that the
                {" "} <code>gsap.to()</code> method animates elements from their
                current state to new state, while the <code>gsap.from()</code> method
                animates from a new state to their current state.
            </p>
